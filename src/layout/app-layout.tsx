...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Customer', path: '/customers', entity: 'customer', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
  ...
  { name: 'Shipment', path: '/shipments', entity: 'shipment', service: AccessServiceEnum.PROJECT, icon: FiPackage },
  { name: 'Supplier', path: '/suppliers', entity: 'supplier', service: AccessServiceEnum.PROJECT, icon: FiUsers },
